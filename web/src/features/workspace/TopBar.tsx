...
export function TopBar() {
  ...
  return (
    <header className="h-14 border-b border-border bg-background/95 backdrop-blur-md flex items-center px-6 gap-6 shrink-0 relative z-40">
      {/* Brand */}
      ...
      <div className="flex-1 flex justify-center" ref={dropdownRef}>
        <div className="relative w-full max-w-xl">
          ...
          {/* Dropdown */}
          {open && (
            <div className="absolute top-full left-0 right-0 mt-2 bg-card rounded-2xl shadow-2xl shadow-black/20 border border-border max-h-[480px] overflow-auto z-50 p-2 animate-in fade-in slide-in-from-top-1">
              {filtered.length === 0 ? (
      ...
      <div className="flex items-center gap-2 shrink-0">
        <div className="flex items-center gap-1 mr-2 px-2 py-1 bg-muted rounded-xl border border-border">
          <div className="relative" ref={themeRef}>
            ...
            {themeMenuOpen && (
              <div className="absolute top-full left-0 mt-3 w-40 bg-card border border-border rounded-2xl shadow-2xl z-[60] p-1.5 animate-in fade-in zoom-in-95 slide-in-from-top-2 duration-200">
          ...
          {[
            { to: '/tasks', icon: Clock, title: 'Tasks' },
            { to: '/billing', icon: CreditCard, title: 'Billing' },
