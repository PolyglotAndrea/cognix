                  ...
                  <div>
                    ...
                    <p className="text-[9px] text-muted-foreground font-medium uppercase tracking-wider">
                      {rightPanelTab === 'artifacts'
                        ? 'Final reports, datasets, captures, and deliverables'
                        : rightPanelTab === 'apps'
                          ? 'Runnable sandbox previews generated by Cognix'
                          : rightPanelTab === 'approvals'
                            ? 'Questions and confirmations needed from you'
                            : rightPanelTab === 'tasks'
                              ? 'Long-running work and scheduled execution'
                              : 'Workspace outputs and supporting context'}
                    </p>
                  </div>
                </>
              )
